...
function getSelectedNetwork(e){
  ...
  if (e.target.innerHTML === "Ethereum Mainnet") {
    providerURL = "https://eth-mainnet.g.alchemy.com/v2/SyfDzrjp_igUQ-lhN3_jpksTLA48Feik"
    ...
    providerURL = "https://shape-sepolia.g.alchemy.com/v2/SyfDzrjp_igUQ-lhN3_jpksTLA48Feik";
    document.getElementById("network").style.display = "none";
  }
...
function myFunction(){
  ...
  fetch("http://localhost:3000/api/v1/tokens/allaccount").then((response) => response.json()).then((data)=> {
    let accounts = "";
